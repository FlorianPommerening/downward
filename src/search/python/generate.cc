...
static void print_header() {
    cout << "#include \"python/binding_generated.h\"" << endl
         << "#include \"python/exception.h\"" << endl << endl
         << "#include \"plugins/doc_printer.h\"" << endl << endl
         << "#include <sstream>" << endl << endl
         << "using namespace std;" << endl << endl
         << "static string get_doc(const plugins::Registry &registry, const string &name) {" << endl
